...
"""
routes['default_controller'] = 'Dojoparty_Controller'
routes['POST']['/register'] = 'Dojoparty_Controller#register'
routes['POST']['/login'] = 'Dojoparty_Controller#login'
routes['GET']['/party'] = 'Dojoparty_Controller#party'
routes['GET']['/logout'] = 'Dojoparty_Controller#logout'
routes['POST']['/add'] = 'Dojoparty_Controller#add'
